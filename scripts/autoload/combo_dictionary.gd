...
# ── Symbol registry (assign your SymbolData .tres files here in the editor) ──
@export var all_symbols: Array[SymbolData] = []

# ── Combo data (Agenda reads this, _check_combos uses it) ────────────────────
const COMBOS: Array = [
	{
		"name": "Quarterly Report",
		"symbol_ids": ["roi", "roi", "roi"],
		"impact": 15, "bandwidth": 0, "morale": 0
	},
	{
		"name": "Team Building Exercise",
		"symbol_ids": ["synergy", "synergy", "synergy"],
		"impact": 10, "bandwidth": 20, "morale": 10
	},
	{
		"name": "Filibuster",
		"symbol_ids": ["circle_back", "put_a_pin_in_it", "synergy"],
		"impact": 0, "bandwidth": 30, "morale": 0
	},
	{
		"name": "Morale Booster",
		"symbol_ids": ["pizza", "pizza", "pizza"],
		"impact": 0, "bandwidth": 0, "morale": 20
	},
	{
		"name": "Tech Startup Pitch",
		"symbol_ids": ["ai", "ai", "pain_point"],
		"impact": 40, "bandwidth": 0, "morale": 0
	},
	{
		"name": "Q3 Earnings Call",
		"symbol_ids": ["leverage", "roi", "synergy"],
		"impact": 25, "bandwidth": 0, "morale": 0
	},
]
...
func _check_combos(results: Array[SymbolData]) -> Dictionary:
	...
	for combo in COMBOS:
		...
		combo_ids.sort()
		if ids == combo_ids:
			return _combo(combo["name"], combo["impact"], combo["bandwidth"], combo["morale"])
